              ...
              <div className="flex flex-col h-full overflow-hidden border-2 border-yellow-200 dark:border-yellow-800 shadow-xl rounded-lg">
                ...
                <div className="p-0">
                  <div className="relative h-[300px] w-full bg-gradient-to-br from-yellow-400/20 to-orange-600/20 overflow-hidden rounded-b-lg">
                    <ImageWithFallback
                      src="/Cocina.jpg"
                      alt="Krispi Prince Dish - A healthy crispy chicken dish prepared according to Pinggang Pinoy guidelines"
                      width={600}
                      height={300}
                        ...
                        <div className="absolute inset-0 bg-gradient-to-br from-yellow-400/20 to-orange-600/20 flex items-center justify-center">
                          <div className="text-center space-y-4">
                            <div className="w-24 h-24 bg-white/20 rounded-full flex items-center justify-center backdrop-blur-sm">
                              <span className="text-4xl" role="img" aria-label="Chef">
                                👨‍🍳
                              </span>
                            </div>
                ...
                <div className="p-6 space-y-6">
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      ...
                      eating. Instead of the usual batter, we use a nutrient-packed mix that gives it a unique crunch
                      and flavor. Paired with a variety of veggies and whole grains, it turns a popular street food into
                      a complete, balanced meal that's both satisfying and wholesome.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {["High Protein", "Balanced Nutrition", "Filipino Fusion", "Student Favorite"].map((feature) => (
                        <span
                          key={feature}
                          className="px-3 py-1 bg-gray-100 dark:bg-gray-800 rounded-full text-sm text-center"
                        >
                          {feature}
                        </span>
                      ))}
                  ...
                  <div>
                    ...
                    <dl className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        <dt>Protein:</dt>
                        <dd className="font-medium">32g</dd>
                      </div>
                      <div className="flex justify-between">
                        <dt>Carbohydrates:</dt>
                        <dd className="font-medium">28g</dd>
                      </div>
                      <div className="flex justify-between">
                        <dt>Healthy Fats:</dt>
                        <dd className="font-medium">18g</dd>
                      </div>
                    </dl>
                  </div>
                </div>
